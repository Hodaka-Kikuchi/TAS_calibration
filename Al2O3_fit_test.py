...
# 理想値のエネルギーは3.635*4=14.54meVすなわち2.3720A
"""
# 理想値
data = np.array([
...
# フィッティング関数 (ΔA1 と ΔA2 を求める)
def fit_function(params, d_hkl, theta_obs):
    ...
    return (theta_calc - theta_obs)  # 残差を返す

# 初期値 (ΔA1 = 0°, ΔA2 = 0°)
initial_guess = [0.0, 0.0]

# 最適化 (ローカル最適化)
result = least_squares(fit_function, initial_guess, args=(d_hkl, theta_obs), method='trf')
